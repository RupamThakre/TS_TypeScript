...
let personAlias: Person | Person[];

//Functions and Types
// declare return types type
...
/**
 * 
 * Below is not return anything - void types 
 */
...
//above line is not giving the error, it should give because performing .split() over an array
//that's why generics concept came into picture
